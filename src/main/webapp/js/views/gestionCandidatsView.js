define([ 'lib/handlebars', 'lib/backbone',
	'lib/text!templates/gestionCandidats.hbs', 'views/headerView',"collections/candidats" ],
	function(Handlebars, Backbone, template_gestionCandidats, HeaderView,Candidats) {
	    var singleton;
		...
		render : function() {
		    ...
		    this.$el.html(template({candidats:this.model.toJSON()}));
